  ...
  return (
    <div className="fixed inset-0 z-[100] flex flex-col items-center justify-center bg-[#FAFAF9] touch-none pointer-events-none select-none">
      ...
      <div className="relative mb-[--spacing-lg] flex flex-col items-center">
        <div className="animate-bounce w-32 h-32 flex items-center justify-center">
      ...
      <div className="mt-[--spacing-xl] flex gap-[--spacing-xs]">
        <div className="w-1.5 h-1.5 bg-primary-fixed-dim rounded-full animate-pulse" />
        <div className="w-1.5 h-1.5 bg-primary-fixed-dim rounded-full animate-pulse [animation-delay:200ms]" />
        <div className="w-1.5 h-1.5 bg-primary-fixed-dim rounded-full animate-pulse [animation-delay:400ms]" />
      </div>
    </div>
  );
}
